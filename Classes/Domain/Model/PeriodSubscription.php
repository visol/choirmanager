 ...
 *
 */
class Tx_Choirmanager_Domain_Model_PeriodSubscription extends Tx_Extbase_DomainObject_AbstractEntity {
	...
	/**
	 * Returns the uidPeriod
	 *
	 * @return integer uidPeriod
	 */
	public function getUidPeriod() {
		return $this->uidPeriod;
	}

	/**
	 * Sets the uidPeriod
	 *
	 * @param integer $uidPeriod
	 * @return void
	 */
	public function setUidPeriod($uidPeriod) {
		$this->uidPeriod = $uidPeriod;
	}
