...
/**
 * Test case for class Tx_Choirmanager_Controller_MembershipPeriodController.
 *
 * @version $Id$
 ...
 */
class Tx_Choirmanager_Controller_MembershipPeriodControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
