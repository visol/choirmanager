...
/**
 * Test case for class Tx_Choirmanager_Controller_CustomFrontendUserController.
 *
 * @version $Id$
 ...
 */
class Tx_Choirmanager_Controller_CustomFrontendUserControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
