...
/**
 * Test case for class Tx_Choirmanager_Domain_Model_ChoirManagerUser.
 *
 * @version $Id$
 ...
 */
class Tx_Choirmanager_Domain_Model_ChoirManagerUserTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_Choirmanager_Domain_Model_ChoirManagerUser
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_Choirmanager_Domain_Model_ChoirManagerUser();
	}
	 ...
	 * @test
	 */
	public function getJobReturnsInitialValueForObjectStorageContainingTx_Choirmanager_Domain_Model_Job() { 
	 ...
	 * @test
	 */
	public function setJobForObjectStorageContainingTx_Choirmanager_Domain_Model_JobSetsJob() { 
		$job = new Tx_Choirmanager_Domain_Model_Job();
		$objectStorageHoldingExactlyOneJob = new Tx_Extbase_Persistence_ObjectStorage();
		$objectStorageHoldingExactlyOneJob->attach($job);
		$this->fixture->setJob($objectStorageHoldingExactlyOneJob);
	...
	public function removeJobFromObjectStorageHoldingJob() {
		...
		$localObjectStorage->attach($job);
		$localObjectStorage->detach($job);
		$this->fixture->addJob($job);
		$this->fixture->removeJob($job);
