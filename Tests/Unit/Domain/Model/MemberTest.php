...
/**
 * Test case for class Tx_Choirmanager_Domain_Model_Member.
 *
 * @version $Id$
 ...
 */
class Tx_Choirmanager_Domain_Model_MemberTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_Choirmanager_Domain_Model_Member
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_Choirmanager_Domain_Model_Member();
	}
